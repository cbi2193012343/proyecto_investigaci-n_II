...
\begin{corolario}[Compatibilidad entre el operador local y el cambio de medida]
\label{prop:compatibilidadCambioMedida}
Bajo las hipótesis de la Proposición~\ref{prop:QYprobabilidad}, la probabilidad
$Q_Y^\Pi$ construida allí satisface
\[
...
\]
para todo $X\in\Delta_n$. Así, $T_Y(X)$ está bien definido en todo $\Delta_n$. No obstante, la restricción a $\Delta_n^\circ$ será el dominio estructural cuando se estudie la composición e inversión de estos operadores.
\end{observacion}
